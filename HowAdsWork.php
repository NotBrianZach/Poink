...
<p>Our database maintains queues for each group, if you're willing to pay more than other people for a given group, you're moved to the front of the line</p>
<p>There's a minimum price of $.05 per ad </p>

<p>Users of the Poink app see your questions whenever they're exposed to new questions. If they like your product they might answer the question and talk about it with friends and even random strangers. We log that data and provide you with the engagement rates for any particular question. That is, the percentage of users who choose to answer it, as well as the number of times the answer to your question was shared by those users with other people.</p>
...
<p>Security is one of our top priorities. No server hooked up to the internet is perfectly secure. Hypothetically one day we'll be licensed. Passwords and sensitive numbers are encrypted, we try to work through third party payment systems like paypal as much as possible to maximize security.</p>
